...
public class ActivityRegister extends ActionBarActivity implements RestTask.ResponseCallback{
    ...
    private void registerByForm(){
        ...
        params.add(new org.apache.http.message.BasicNameValuePair("registration", "form"));
        params.add(new org.apache.http.message.BasicNameValuePair("gender", gender));
        params.add(new org.apache.http.message.BasicNameValuePair("email", et_email_reg.getText().toString()));
        params.add(new org.apache.http.message.BasicNameValuePair("fName", et_fname_reg.getText().toString()));
        params.add(new org.apache.http.message.BasicNameValuePair("lName", et_lname_reg.getText().toString()));
        params.add(new org.apache.http.message.BasicNameValuePair("password", et_password_reg.getText().toString()));
        try{
